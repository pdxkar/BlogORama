	...
	<div id="container">
		<div id="header">
			...
			<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
				...
				<div class="row-fluid">
						<div class="span4">
							<a href="<%=_appContext_%>" class="homeLink">Home</a>
						</div>


		<div class="span4">
							<a href="<%=_appContext_%>/about"> About</a>
						</div>

						<div class="span4">
							<a href="<%=_appContext_%>/about">homeaboutpng</a>
						</div>
		...
		<div id="footer">
			...
			<nav class="navbar navbar-default navbar-centered" role="navigation"
				...
				<div class="row-fluid">
						...
						<div class="span2">
							<a href="http://www.catalystsolves.com" target="_blank">catalystlogo</a>
						</div>
			...
			<div id="copyRight">
				<strong>Copyright ©2013 Catalyst IT Services, Beaverton, OR</strong>
			</div>
		</div>
	</div>
